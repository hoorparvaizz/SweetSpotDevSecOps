...
import type { Order, VendorStats } from "@/types";
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center space-y-4 md:space-y-0">
        ...
        <div className="flex space-x-3">
          ...
          <Button variant="outline" onClick={() => setLocation("/vendor/orders")}>
            View All Orders
          </Button>
        </div>
      </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-blue-600 flex items-center">
                      ...
                      {recentOrders.filter((o: Order) => o.status === "pending").length} pending
                    </p>
                  </div>
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <Card className="border-0 shadow-lg bg-card/50">
          <CardHeader className="flex flex-row items-center justify-between">
            ...
            <Button variant="outline" size="sm" onClick={() => setLocation("/vendor/orders")}>
              View All
            </Button>
          </CardHeader>
          <CardContent>
                  ...
                  <div key={order.id} className="flex items-center justify-between p-4 border rounded-xl hover:bg-muted/50 transition-colors">
                    <div className="space-y-1">
                      <div className="flex items-center space-x-2">
                        ...
                        <Badge variant={getOrderStatusColor(order.status) as any} className="text-xs">
                          {order.status}
                        </Badge>
                      </div>
                      <p className="text-sm text-muted-foreground">
          ...
          <Card className="border-0 shadow-lg bg-card/50">
            ...
            <CardContent className="space-y-3">
              ...
              <Button 
                variant="outline" 
                className="w-full justify-start"
                onClick={() => setLocation("/vendor/subscriptions")}
              >
