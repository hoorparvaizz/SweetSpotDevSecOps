    ...
    <div className="space-y-12">
            ...
            <div className="relative rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute -top-4 -left-4 bg-white/90 backdrop-blur rounded-2xl p-4 shadow-xl">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-800">Fresh Daily</span>
                </div>
              </div>
      ...
      <section>
        <div className="space-y-8">
          <div className="text-center space-y-4">
            <h2 className="text-3xl font-bold text-foreground">Featured Artisan Desserts</h2>
      ...
      <section className="rounded-3xl gradient-mint p-8 lg:p-12 text-white">
        <div className="text-center space-y-8">
          <div className="space-y-4">
            <h2 className="text-3xl font-bold">Sweet Surprise Box</h2>
            <p className="text-lg text-white/80 max-w-2xl mx-auto">
              Get a curated selection of artisan desserts delivered monthly. Each box features 6-8 premium desserts 
              from different local artisans, carefully selected by our taste experts.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center space-y-4">
              ...
              <p className="text-sm text-white/70">Hand-picked premium desserts</p>
            </div>
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto">
                <span className="text-2xl">🚚</span>
              </div>
              <h3 className="font-semibold">Monthly Delivery</h3>
              <p className="text-sm text-white/70">Fresh desserts every month</p>
            </div>
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto">
                <span className="text-2xl">🎁</span>
              </div>
              <h3 className="font-semibold">Surprise & Delight</h3>
              <p className="text-sm text-white/70">Discover new artisan flavors</p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              ...
              onClick={() => setLocation("/subscriptions")}
            >
              Start Subscription - $29.99/month
            </Button>
            <Button 
              size="lg" 
              variant="outline" 
